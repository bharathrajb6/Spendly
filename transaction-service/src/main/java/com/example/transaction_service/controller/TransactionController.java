...
public class TransactionController {
    ...
    public TransactionResponse addTransaction(@RequestHeader("X-Username") String username,
    ...
    public Page<TransactionResponse> getAllTransactions(@RequestHeader("X-Username") String username,
    ...
    public TransactionResponse updateTransaction(@RequestHeader("X-Username") String username,
            @PathVariable String transactionID, @RequestBody TransactionRequest request) throws InterruptedException {
    ...
    public Page<TransactionResponse> getTransactionFilter(@RequestHeader("X-Username") String username,
    ...
    public Page<TransactionResponse> getTransactionByCategory(@RequestHeader("X-Username") String username,
            @PathVariable String value, @PageableDefault(size = 10, page = 0) Pageable pageable) {
    ...
    /**
     * Retrieves all transactions for a given username within a given month and
     * year.
     *
     * @param username The username for which all transactions are being retrieved.
     * @param month    The month for which all transactions are being retrieved.
     * @param year     The year for which all transactions are being retrieved.
     * @param pageable The pageable object containing the page and size details.
     * @return A page of transaction response objects containing all transactions
     *         for the given user within the given month and year.
     * @throws TransactionException If the username is null, or if the month or year
     *                              is invalid.
     */
    @RequestMapping(value = "/transaction/filter/month", method = RequestMethod.GET)
    public Page<TransactionResponse> getTransactionByMonth(@RequestHeader("X-Username") String username,
            @RequestParam("month") int month, @RequestParam("year") int year, Pageable pageable) {
        return transactionService.getTransactionByMonth(username, month, year, pageable);
    }

    /**
     * Retrieves the total amount of transactions for the given user within a given
     * month and year.
     *
     * @param username The username for which the total amount of transactions is
     *                 being retrieved.
     * @param month    The month for which the total amount of transactions is
     *                 being retrieved.
     * @param year     The year for which the total amount of transactions is
     *                 being retrieved.
     * @return The total amount of transactions for the given user within the given
     *         month and year.
     * @throws TransactionException If the username is null, or if the month or year
     *                              is invalid.
     */
    @RequestMapping(value = "/transaction/total", method = RequestMethod.GET)
    public Map<String, Double> getTotalTransactionAmountInTheMonth(@RequestHeader("X-Username") String username,
     ...
     * @return The total amount of transactions for the given user within the given
     *         year.
     * @throws TransactionException If the username is null, or if the year is
     *                              invalid.
     */
    @RequestMapping(value = "/transaction/total/year", method = RequestMethod.GET)
    public Map<String, Double> getTotalTransactionAmountInYear(@RequestHeader("X-Username") String username,
            @RequestParam("year") int year) {
        return transactionService.getTotalTransactionAmountInYear(username, year);
    }

    /**
     * Retrieves the total savings for the given user.
     *
     * @param username The username for which the total savings is being retrieved.
     * @return The total savings for the given user.
